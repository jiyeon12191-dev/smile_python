...
# 변수의 범위 - 지역변수(함수안에서 만들어진것) , 전역변수(어디서든 가능함)
...
# 문제1. 간단한 함수 만들기 
# 사각형의 너비와 높이를 받아서 넓이를 출력하는 함수를 만들어 호출해 보세요 
# 함수에서 넓이 구하는 계산식 있어야 하고 출력도 있어야 한다 
...
if login_check(id,pw): # 여기 부분을 함수로 처리 될수 있게 
    print("로그인 성공 하였습니다")
else:
    print("아이디 또는 비밀번호를 잘못 입력 했습니다")

#문제 3. 상품의 재고를 확인하여 재고 충분,재고 부족, 품절 이라고 출력 할수있는 함수 만들기 
    ...
    if item_stock > 8 :
        ...
        print("품절")    
    # 위 코드를 print( 함수 호출 ) 이렇게 실행 하면 동작할수 있게 함수 만드세요 
...
# id_list 현재 가입된 회원들의 아이디만 저장된 리스트이다 
