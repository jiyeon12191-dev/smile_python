...
# 아이디또는 비밀번호가 잘못되있습니다 출력
# 아이디는 진섭 , 비밀번호는 babo

# id = input("아이디 :")
# password = input("비밀번호 : ")

# if id == '진섭' and password == 'babo':
#     print("로그인 성공")
# else:
...
# word안에 동렬 이름이 없다라는 것을 확인 할수 있는 코드 만드세요
...
#문자열 바꾸기 .replace("현재 문자열에서 변경 할 문자열" , "교체할 문자열")
...
# 문제3. 회원가입시 이메일 입력을 하는데 회사 특정 주소만 가능하다
# naver.com , gmail.com , nate.com , daum.net
# 위 4개만 가능하다 
# input으로 이메일을 입력 받아서 가입 가능인지 불가능인지 출력 
# endswith 특정문자로 끝나는 문장을 찾을때 사용 
...
# 문제 4. 금액 계산하기 
# 각 업체 별로 입금이 되었다 총액이 얼마인지 출력하세요 
쿠팡 = "135,900원"
네이버 = "540,000원"
오드론 = "2,340,090원"
