...
# # 5번 반복하는 반복문 (1,6)은 1부터 5까지 표현 (1,6,2)은 2씩 증가 
...
# #문제1. 1부터 10까지 총합을 구하세요 반복문을 사용해서 
# sum = 0
# for i in range(1,11):
#     sum = sum + i
# print("총합 : " + str(sum)) 
