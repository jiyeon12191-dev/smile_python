...
# 리스트 자르기 
num = number[2:4] # 2번 인덱스 부터 4번 인덱스 전까지 
print( num )
num2 = number[:3] # 0번부터 3번 전까지 
print(num2)
num3 = number[2:] # 2번부터 
print(num3)
...
print( number )
del number[2] # 인덱스로 삭제 (참조되어있는공간을 삭제)
print( number ) 
...
for i , num in enumerate(number): # 인덱스와값을 동시에 가져올때 enumerate 사용
    print(i, num)    
...
print(number)  
number.sort(reverse=True)  # reverse는 내림차순
print( number )
...
#문제 4. 이름 리스트에 내림차순으로 정렬 하여 출력 하세요
...
# 문제 7. 구매 할 과일을 입력하면 총 지불 금액 얼마인지 출력 
# fruits.sort() # 딸기, 바나나,배,사과,오렌지,파인애플,포도
# price = [5000,8000,12000,9500,]
# fname = input("구매할 과일을 입력하세요:").split()
# tot = 0
# for f in fname:
#     if f in fruits:
#         idx = fruits.index(f)
